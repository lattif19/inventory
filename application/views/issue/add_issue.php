<div class="row" ng-controller="trxIssue">
  <!-- TRX BARCODE -->
            ...
            <table class="table table-hover no-margin">
              ...
              <tbody>
                <tr ng-class="{info : activeItem === $index}" ng-repeat="itemList in dataItem" ng-click="showItemImage($index)">
                  ...
                  <td>
                    <select class="form-control"  ng-change="checkStock(dataItem[$index].itemNumber,dataItem[$index].location_id,dataItem[$index].conditioncode,$index)" ng-init="dataItem[$index].location_id='1203'" ng-model="dataItem[$index].location_id" ng-disabled="dataLocation">
                  ...
                  <td>
                    <select class="form-control" ng-change="checkStock(dataItem[$index].itemNumber,dataItem[$index].location_id,dataItem[$index].conditioncode,$index)" ng-init="dataItem[$index].conditioncode='NEW-MATERIAL'" ng-model="dataItem[$index].conditioncode"  ng-disabled="dataLocation">
                  ...
                  <td ng-init="checkStock(dataItem[$index].itemNumber,dataItem[$index].location_id,dataItem[$index].conditioncode,$index)"> 
    ...
    <div class="box-body">
      <div class="row">
        <div class="col-md-12">
          ...
          <input type="submit"  onclick="myFunctionPrint('<?= $autoPrint+1 ?>')" class="btn btn-primary btn-block btn-sm" ng-click="saveData(dataItem,dataWO,dataIssueTo,dataShipper)" ng-disabled="cekFinish()"/>
        </div><!-- ./chart-responsive -->
      </div><!-- /.col -->
    </div><!-- /.row -->
  </form>
