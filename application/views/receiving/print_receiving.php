...
<body style="margin-left: 0px">
	...
	<table>
		...
		<?php foreach ($dataItem as $value) { ?>
			<tr>
				<td><strong><?php echo $value->item_number; ?> <?php echo intval($value->receivedqty); ?> <?php echo $value->receivedunit;?>  <?php echo $value->conditioncode; ?> <?php echo $value->description; ?><br><?php echo $value->timestamp; ?></strong></td>
			</tr>
		<?php } ?>
		<tr>
			<td>===============================================</td>
