      ...
      <div class="box-body">
       <div class="form-group">
        <form ng-submit="getItem(itemNumber)">
          <input id="show1" name="barcode" autocomplete="off" ng-model="itemNumber" type="text" placeholder="BARCODE" class="form-control input-lg" ng-disabled="dataPO.poNumber==null&&dataCompany.companyId==null">
        </form>
    ...
    <div class="box-body">
      <div class="row">
        <div class="col-md-12">
          ...
          <!-- <input type="submit" onclick="myFunctionPrint('<?= $autoPrint ?>')" class="btn btn-primary btn-block btn-sm" ng-click="saveData(dataItem,dataPO,dataCompany,dataShipper)" ng-disabled="cekFinish()"/> -->
